...
public class IfStatementPractice {
    public static void main(String[] args) {
        ...
        if (password.length() >= 8) {
            ...
            System.out.println("Passoword is too short, needs to be last 8 characters long.");
        }
        ...
        char grade = 'A';
        if (grade == 'A') {
            System.out.println("Exelent grade!");
        } else {
            System.out.println("Your grade is not 'A'.keep trying");
        }
    ...
    if (number > 0) {
        ...
        // Your code here:
        if (numbers.length >3) {
            System.out.println("Aray has sufficient elements!");
        }
